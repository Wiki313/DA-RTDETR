...
from src.da.grl import WarmStartGradientReverseLayer
...
class HybridEncoder(nn.Module):
    def __init__(self,
        ...
        self.domain_enc = nn.Embedding(1, hidden_dim)
        self.out_channels = [hidden_dim for _ in range(len(in_channels))]
        self.out_strides = feat_strides
        self.da_query = DA_Query()
