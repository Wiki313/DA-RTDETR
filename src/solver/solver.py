...
class BaseSolver(object):
    ...
    def train(self, ):
        ...
        self.train_dataloader_source = dist.warp_loader(self.cfg.train_dataloader_source, \
            shuffle=self.cfg.train_dataloader_source.shuffle)

        self.train_dataloader_target = dist.warp_loader(self.cfg.train_dataloader_target, \
                                                 shuffle=self.cfg.train_dataloader_target.shuffle)
