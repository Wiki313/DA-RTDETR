...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self._train_dataloader_source: DataLoader = None
        self._train_dataloader_target: DataLoader = None
        self._val_dataloader :DataLoader = None 
        self._ema :nn.Module = None 
        self._scaler :GradScaler = None 

        self.train_dataset_source :Dataset = None
        self.train_dataset_target: Dataset = None
    ...
    @property
    def train_dataloader_source(self):
        if self._train_dataloader_source is None and self.train_dataset_source is not None:
            loader = DataLoader(self.train_dataset_source,
                                batch_size=self.train_batch_size, 
                                num_workers=self.num_workers, 
                                collate_fn=self.collate_fn,
                                shuffle=self.train_shuffle, )
            loader.shuffle = self.train_shuffle
            self._train_dataloader_source = loader

        return self._train_dataloader_source

    @property
    def train_dataloader_target(self):
        if self._train_dataloader_target is None and self.train_dataset_target is not None:
            loader = DataLoader(self.train_dataset_target,
                                batch_size=self.train_batch_size,
                                num_workers=self.num_workers,
                                collate_fn=self.collate_fn,
                                shuffle=self.train_shuffle, )
            loader.shuffle = self.train_shuffle
            self._train_dataloader_target = loader

        return self._train_dataloader_target


    @train_dataloader_source.setter
    def train_dataloader_source(self, loader):
        self._train_dataloader_source = loader

    @train_dataloader_target.setter
    def train_dataloader_target(self, loader):
        self._train_dataloader_target = loader
